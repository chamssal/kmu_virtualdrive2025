...
struct MD5Sum< ::morai_msgs::EgoVehicleStatus_<ContainerAllocator> >
{
  ...
  {
    return "80881e991d003bd91799da1ac1fef221";
  }

  static const char* value(const ::morai_msgs::EgoVehicleStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x80881e991d003bd9ULL;
  static const uint64_t static_value2 = 0x1799da1ac1fef221ULL;
};
