...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /home/foscar/kmu_virtualdrive2025/src/openslam_gmapping)
  set(openslam_gmapping_DEVEL_PREFIX /home/foscar/kmu_virtualdrive2025/devel)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /home/foscar/kmu_virtualdrive2025/install)
...
if(NOT "/home/foscar/kmu_virtualdrive2025/src/openslam_gmapping/include;/home/foscar/kmu_virtualdrive2025/devel/include " STREQUAL " ")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/home/foscar/kmu_virtualdrive2025/src/openslam_gmapping/include;/home/foscar/kmu_virtualdrive2025/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/foscar/kmu_virtualdrive2025/src/openslam_gmapping/${idir}'.  ${_report}")
    endif()
