...
if("TRUE" STREQUAL "TRUE")
  set(vesc_driver_SOURCE_PREFIX /home/foscar/kmu_virtualdrive2025/src/vesc/vesc_driver)
  set(vesc_driver_DEVEL_PREFIX /home/foscar/kmu_virtualdrive2025/devel)
  ...
  set(vesc_driver_INSTALL_PREFIX /home/foscar/kmu_virtualdrive2025/install)
...
if(NOT "/home/foscar/kmu_virtualdrive2025/src/vesc/vesc_driver/include " STREQUAL " ")
  set(vesc_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/foscar/kmu_virtualdrive2025/src/vesc/vesc_driver/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/foscar/kmu_virtualdrive2025/src/vesc/vesc_driver/${idir}'.  ${_report}")
    endif()
...
set(depends "nodelet;pluginlib;std_msgs;vesc_msgs;serial")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(vesc_driver_EXPORTED_TARGETS ${${vesc_driver_dep}_EXPORTED_TARGETS})
endforeach()
