...
void obstacle_detector::ScansMergerPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ScansMergerPanel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject obstacle_detector::ScansMergerPanel::staticMetaObject = { {
    &rviz::Panel::staticMetaObject,
    qt_meta_stringdata_obstacle_detector__ScansMergerPanel.data,
    qt_meta_data_obstacle_detector__ScansMergerPanel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
