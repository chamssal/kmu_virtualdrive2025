...
void obstacle_detector::ObstacleExtractorPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ObstacleExtractorPanel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject obstacle_detector::ObstacleExtractorPanel::staticMetaObject = { {
    &rviz::Panel::staticMetaObject,
    qt_meta_stringdata_obstacle_detector__ObstacleExtractorPanel.data,
    qt_meta_data_obstacle_detector__ObstacleExtractorPanel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
